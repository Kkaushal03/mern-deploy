...
//all the emails are the displayed with the help of this
//with the help of navigate we are calling
//with the help of filter function we are selecting specific email
...
const toggleStarredMails = () =>{
    toggleStarredService.call({id : email._id, value: !email._starred });
